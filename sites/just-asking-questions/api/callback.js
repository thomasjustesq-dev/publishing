/**
 * Decap CMS — complete GitHub OAuth and postMessage the token to the admin opener.
 * Env: OAUTH_GITHUB_CLIENT_ID, OAUTH_GITHUB_CLIENT_SECRET, OAUTH_ORIGINS
 *
 * OAUTH_ORIGINS: comma-separated origins allowed to receive the token
 * (e.g. https://www.just-asking-questions.com,https://www.theadversarialsystem.com).
 * Defaults to both publication sites.
 */
